...
from source2.constants import Point, font, White, Red, Black, Blue, Green, Yellow, Purple, Cyan, Brown, Grey, BLOCK_SIZE, Forward
...
class Player:
    def __init__(self, Point, width, height, rand, level, timeDeath=1260):
        ...
        self.timeBeforeDeath = timeDeath / Forward
        self.evolve_time = 0
    ...
    def show(self):
        ...
        print ("timeBeforeDeath: " + str(self.timeBeforeDeath))
        print ("evolve_time: " + str(self.evolve_time))
        print ("\n------------------")